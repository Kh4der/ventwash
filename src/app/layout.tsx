  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Archivo:wght@500;700;800&family=Great+Vibes&family=IBM+Plex+Mono:wght@400;500&family=Instrument+Serif:ital@0;1&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
